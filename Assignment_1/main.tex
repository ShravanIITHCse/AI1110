...
\section*{Solution -:}
\subsection*{Given,}
Balls in the urn \brak{N} = 25, 


Balls marked with $X$ \brak{N_X} = 10 


Balls marked with $Y$ \brak{N_Y} = 15 
...
\subsection*{(i)}
\begin{align}
	\pr{Z = 6} &= \binom{6}{0}\,\brak{\frac{2}{5}}^6\,\brak{\frac{3}{5}}^{0}
...
\subsection*{(ii)}
\begin{align}
	\pr{Z >= 4} &= \pr{Z = 4} + \pr{Z = 5} + \pr{Z = 6} \\&= \binom{6}{0}\,\brak{\frac{2}{5}}^6\,\brak{\frac{3}{5}}^0
	\\&= \brak{\frac{2}{5}}^6 \\&= \frac{64}{15625} 
\end{align}

\subsection*{(iii)}
\begin{align}
	\pr{Z <= 6} &= 1-\pr{Z = 4} \\&= 1 - \binom{6}{6}\,\brak{\frac{2}{5}}^6\,\brak{\frac{3}{5}}^0
	\\&= \frac{15561}{15625}  
\end{align}
