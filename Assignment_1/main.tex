...
%\numberwithin{equation}{enumi}
	...
	\section*{Solution -:}
	\subsection*{\hspace{4ex}Given,}
		Balls in the urn \((N)\) = 25, 
		
		
		Balls marked with X ($N_X$) = 10 
		
		
		Balls marked with Y ($N_Y$) = 15 
		
		
		Probability of an event $E$, \pr{E} is defined as
		\begin{align}
		...
		In all the following Subquestion value of n is 6
		
	\subsection*{(i)}
		\begin{align}
			\pr{Z = 6} &= \binom{6}{0}\,(\frac{2}{5})^6\,(\frac{3}{5})^{0}
			 \\&= (\frac{2}{5})^6 \\&= \frac{64}{15625} 
		\end{align}
		 
	
	\subsection*{(ii)}
		\begin{align}
			\pr{Z >= 4} &= \pr{Z = 4} + \pr{Z = 5} + \pr{Z = 6} \\&= \binom{6}{0}\,(\frac{2}{5})^6\,(\frac{3}{5})^{0}
			\\&= (\frac{2}{5})^6 \\&= \frac{64}{15625} 
		\end{align}
		
	\subsection*{(iii)}
		\begin{align}
			\pr{Z <= 6} &= 1-\pr{Z = 4} \\&= 1 - \binom{6}{6}\,(\frac{2}{5})^6\,(\frac{3}{5})^0
			\\&= \frac{15561}{15625}  
		\end{align}
	
	\subsection*{\hspace{4ex}(iv)}
		\begin{align}
			\pr{Z = 3} &= \binom{6}{3}\,(\frac{2}{5})^3\,(\frac{3}{5})^3 \\&= \frac{4320}{15625}
			\\&= \frac{864}{3125} 
		\end{align}
