...
\begin{abstract}
	...
	Let \frac{3/4}be the probability that he knows the answer and
4
4
...
\begin{align}
	...
	\therefore   
	F_Z(i)&=\sum_{r=0}^i{\comb{6}{r}}\cdot p^r\cdot q^{6-r} \label{eq3}
\end{align}
Some Required Values, from \eqref{eq3}
\begin{align}	
	F_Z(3)&=\comb{6}{0}\brak{0.4}^0\brak{0.6}^6
	+\comb{6}{1}\brak{0.4}^1\brak{0.6}^5
	\\&+\comb{6}{2}\brak{0.4}^2\brak{0.6}^4
	+\comb{6}{3}\brak{0.4}^3\brak{0.6}^3 \\&= 0.8208\label{eq6}\\
	F_Z(5) &= 1-Pr(6)
	\\&=0.995904\label{eq8}
\end{align}
